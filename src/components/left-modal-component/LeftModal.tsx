...
type CadastroField = {
  name: keyof CadastroDTO; // 🔒 Garante que só use campos existentes no DTO
  label: string;
  placeholder?: string;
  error?: boolean;
  helper?: string;
...
const cadastroFields: CadastroField[] = [
  ...
  { name: "corVeiculo", label: "Cor do veículo", placeholder: "Ex: Branco, Azul..." },
  { name: "placa", label: "Placa do caminhão", placeholder: "Ex: ABC-1234" },
  { name: "modelo", label: "Modelo", placeholder: "Ex: Scania R450" },
  { name: "pesoVazio", label: "Peso vazio (kg)", placeholder: "Ex: 7000", error: errors.pesoVazio },
